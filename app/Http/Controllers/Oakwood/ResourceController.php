...
namespace App\Http\Controllers\Oakwood;
...
class ResourceController extends Controller
{
  ...
  public function Less(){
        ...
        $css = app('App\Http\Controllers\Oakwood\ResourceController')->minify_css($parser->getCss());
        ...
        $compiled = app('App\Http\Controllers\Oakwood\ResourceController')->minify_css($compiled);
